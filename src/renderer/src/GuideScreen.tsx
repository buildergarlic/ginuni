    ...
    <div className="manual-shell">
      ...
      <section className="manual-section" aria-labelledby="guide-start">
        ...
        <ol className="manual-steps">
          ...
          <li><span className="manual-number">3</span><h3>듣고, 쓰고, 저장해요</h3><p>영상을 보며 대사를 고치고, 해설 칸에는 작가님이 직접 화면해설을 작성하세요.</p><p>확인한 행은 <b>확인 완료 · 다음</b>으로 표시한 뒤 <b>대본 내보내기 → HWPX 내보내기</b>로 저장합니다.</p><span className="manual-caption">문장을 고치는 것과 확인 완료는 별개예요</span></li>
        </ol>
      ...
      <section className="manual-section" aria-labelledby="guide-check">
        ...
        <ol className="manual-check-flow"><li><strong>다음 확인할 행</strong><span>남은 곳으로 이동</span></li><li><strong>영상과 대본 대조</strong><span>대사·해설·시간 확인</span></li><li><strong>확인 완료 · 다음</strong><span>확인을 기록하고 다음 구간으로 이동</span></li></ol>
      ...
      <section className="manual-section" aria-labelledby="guide-extras">
        ...
        <p><b>작업 도구</b> 또는 영상 아래 <b>원문과 작업 기록</b>을 누르면 행 분할·병합, 사용 권리와 외부 전송 설정, 교정 제안, 이전 저장본과 작업 기록을 볼 수 있습니다. 설정·About·후원도 작업 도구에서 엽니다.</p>
