...
const api: AppApi = {
  ...
  prepareProjectMedia: (id) => ipcRenderer.invoke('project:prepare-media', id),
  previewSubtitleImport: (id, revision, options) => ipcRenderer.invoke('project:preview-subtitle', id, revision, options),
