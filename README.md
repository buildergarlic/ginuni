...
[화면해설 대본 도구 v0.5.0-beta.2 설치 파일 내려받기](https://github.com/buildergarlic/ginuni/releases/download/v0.5.0-beta.2/ScreenDescriptionScriptMaker-0.5.0-beta.2-Setup.exe)
