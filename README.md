...
위 주소는 GitHub Pages 배포 대상입니다. 공개 배포 성공과 실제 접속 확인 후 대회 서비스 링크로 사용하세요.

- 회원가입 없이 45초 연습용 장면과 예시 대본을 편집하거나 내 영상·SRT로 시작할 수 있습니다. 샘플은 직접 만든 움직이는 장면 카드이며 촬영 영상이나 AI 분석 결과가 아닙니다.
- 무료 브라우저 AI로 최대 5분·100MB 파일의 한국어 대사 초안을 만듭니다. 처음에는 모델 다운로드가 필요하며 음성 분석은 사용자 기기에서 실행됩니다.
