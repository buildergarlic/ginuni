...
2026년 9월 19일 실제 공개 영화 샘플과 긴 영상 분할 분석을 GitHub Pages에 배포했습니다. 공개 주소에서 영상 재생·편집·파일 내보내기와 128MB·6분 6초 영상의 실제 AI 분석을 확인했습니다. 대회 서비스 링크에는 위 웹 작업실 주소를 사용하세요.

- 회원가입 없이 실제 1906년 기록영화의 60초 구간을 재생하며 해설 초안 6행을 편집하거나 내 영상·SRT로 시작할 수 있습니다. [공개 영상 출처와 권리 안내](docs/SAMPLE_MEDIA.md)가 있으며, 무성 영화에 가상의 대사나 음악을 추가하지 않았습니다.
- 무료 브라우저 AI로 최대 3시간 영상의 한국어 대사 초안을 만듭니다. 지원되는 브라우저·코덱에서는 파일을 60초씩 순서대로 읽고 분석하므로 100MB 파일 제한이 없습니다. 구간별 읽기를 지원하지 않는 환경의 대체 분석은 5분·100MB 이하로 제한됩니다. 처음에는 모델 다운로드가 필요하며 분석은 사용자 기기에서 실행됩니다.
