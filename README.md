...
[화면해설 대본 도구 v0.4.0-beta.8 설치 파일 내려받기](https://github.com/buildergarlic/ginuni/releases/download/v0.4.0-beta.8/ScreenDescriptionScriptMaker-0.4.0-beta.8-Setup.exe)
